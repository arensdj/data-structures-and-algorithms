...
const standardizePhoneNumbers = (arr) => {
  ...
  arr.forEach(phoneNumber => {
    let number = phoneNumber.substring(1, 4) + phoneNumber.substring(6, 9) +
      phoneNumber.substring(10, 14);
